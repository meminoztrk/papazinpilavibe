...
namespace NLayer.API.Modules
{
    public class RepoServiceModule:Module
    {
        protected override void Load(ContainerBuilder builder)
        {
            ...
            //builder.RegisterType<ProductServiceWithCaching>().As<IProductService>(); //Ön bellekten verileri almak istiyorsan bunu kullan, Service den kullandığın sonu service adlı servisinin adını değiş
